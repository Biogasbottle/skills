...
- **[memory-init](./memory-init/SKILL.md)** — Initialize a repo-first Markdown memory system with `AGENTS.md`, `CONTEXT.md`, `project-memory`, ADRs, PRDs, and handoff conventions.
- **[memory-patch](./memory-patch/SKILL.md)** — Propose and optionally apply distilled project memory updates after meaningful work.
...
- **[design-plan](./design-plan/SKILL.md)** — Convert an approved PRD into an implementation-ready technical design covering architecture, interfaces, data models, execution flow, and task planning.
